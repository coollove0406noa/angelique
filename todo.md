...
- [ ] 1. セッション開始自動切替：WaitingRoomでsession_startedイベント受信→チャット画面切替を確認
- [ ] 2. 短いメッセージ折りたたみ廃止：全メッセージが全文表示されることを確認
- [ ] 3. タイマーをtimerStartedAt基準のカウントダウンに変更・5分前/1分前アラート確認
- [ ] 4. タイマー・延長確認バーを画面上部固定表示・チャット内URLテキスト削除を確認
- [ ] 5. 延長二重加算バグ修正を確認（10分延長→10分のみ追加）
- [ ] 6. 管理者終了時にお客様画面に「鑑定が終了しました。ありがとうございました。」表示を確認
- [ ] 7. タロット表示15秒・フェード2秒を確認
